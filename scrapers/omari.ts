...
const run = async (url:string): Promise<PrayerTimes> => {
  ...
  const prayerTimes: PrayerTimes = {
    ...
    dhuhr: {
      ...
      iqama: $(
        "body > table > tbody > tr:nth-child(4) > td:nth-child(3)"
      ).text(),
    },
    asr: {
      athan: $(
      ...
      iqama: $(
        "body > table > tbody > tr:nth-child(5) > td:nth-child(3)"
      ).text(),
    },
    maghrib: {
      athan: $(
      ...
      iqama: $(
        "body > table > tbody > tr:nth-child(6) > td:nth-child(3)"
      ).text(),
    },
    isha: {
      athan: $(
      ...
      iqama: $(
        "body > table > tbody > tr:nth-child(7) > td:nth-child(3)"
      ).text(),
    },
  };
  return prayerTimes;
